...
# SETTINGS
VITE_BUNDLE_KEYWORD = getattr(settings, 'VITE_BUNDLE_KEYWORD', VITE_BUNDLE_KEYWORD_DEFAULT)  # noqa: E261
VITE_CONFIG = getattr(settings, 'VITE_CONFIG', VITE_CONFIG_DEFAULT)  # noqa: E261
VITE_EXTENSION_MAP = getattr(settings, 'VITE_EXTENSION_MAP', VITE_EXTENSION_MAP_DEFAULT)  # noqa: E261
VITE_IMPORT_KEYWORD = getattr(settings, 'VITE_IMPORT_KEYWORD', VITE_IMPORT_KEYWORD_DEFAULT)  # noqa: E261
VITE_NODE_MODULES = getattr(settings, 'VITE_NODE_MODULES', VITE_NODE_MODULES_DEFAULT)  # noqa: E261
VITE_OUT_DIR = str(settings.STATIC_ROOT)
VITE_PORT = getattr(settings, 'VITE_PORT', VITE_PORT_DEFAULT)  # noqa: E261
VITE_ROOT = getattr(settings, 'VITE_ROOT', VITE_NODE_MODULES_DEFAULT)  # noqa: E261
