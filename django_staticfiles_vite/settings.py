...
VITE_EXTRA_PATHS_DEFAULT = []
VITE_EXTRA_ALLOWED_PATHS_DEFAULT = []

# SETTINGS
VITE_EXTRA_PATHS = getattr(
    settings, "VITE_EXTRA_PATHS", VITE_EXTRA_PATHS_DEFAULT
)  # noqa: E261
VITE_EXTRA_ALLOWED_PATHS = getattr(
    settings, "VITE_EXTRA_ALLOWED_PATHS", VITE_EXTRA_ALLOWED_PATHS_DEFAULT
)  # noqa: E261
